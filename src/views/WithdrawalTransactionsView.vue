            ...
            <tr v-for="transaction in withdrawalTransactionsStore.getFilteredTransactions()" :key="transaction.id">
              ...
              <td class="px-2 sm:px-4 md:px-6 py-3 sm:py-4 hidden lg:table-cell">
                <select
                  ...
                  :disabled="withdrawalTransactionsStore.isLoading || updatingPaymentApiId === transaction.id"
          ...
          <div class="inline-block transform overflow-hidden rounded-lg bg-white text-left align-bottom shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg sm:align-middle">
            ...
            <div class="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
              <button 
                ...
                class="inline-flex w-full justify-center rounded-md border border-transparent bg-primary px-4 py-2 text-base font-medium text-white shadow-sm hover:bg-primary-dark focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 sm:ml-3 sm:w-auto sm:text-sm"
              >
                Fermer
              </button>
            </div>
          ...
          <div class="inline-block transform overflow-hidden rounded-lg bg-white text-left align-bottom shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg sm:align-middle">
            ...
            <div class="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
              ...
              <button 
                ...
                class="mt-3 inline-flex w-full justify-center rounded-md border border-gray-300 bg-white px-4 py-2 text-base font-medium text-gray-700 shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 sm:mt-0 sm:ml-3 sm:w-auto sm:text-sm"
              >
                Annuler
              </button>
            </div>
...
async function handlePaymentApiChange(transaction: Transaction, value: string) {
  ...
  try {
    ...
    await withdrawalTransactionsStore.updateTransactionPaymentApi(transaction.id, paymentApi)
