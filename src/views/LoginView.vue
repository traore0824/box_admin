    ...
    <div class="bg-white rounded-lg shadow-lg p-16 w-[48rem] h-auto min-h-[28rem]">
      ...
      <form @submit.prevent="handleLogin" class="space-y-6">
        ...
        <button
          ...
          class="w-full bg-primary-600 text-white py-3 px-4 rounded-lg font-medium hover:bg-primary-700 focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 transition duration-200 flex items-center justify-center"
